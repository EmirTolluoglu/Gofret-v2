...
!(function(e) {
    ...
    (t.prototype.formatDate = function(t, a, n) {
        ...
        (t = []);
        for (
            var s = e.extend([], a.separators), r = 0, d = a.parts.length; r <= d; r++
        )
            s.length && t.push(s.shift()), t.push(l[a.parts[r]]);
        return t.join("");
    }),
    ...
    (t.prototype.hasSameDayEventType = function(e, t) {
        for (var a = this, n = 0, i = 0; i < a.options.calendarEvents.length; i++)
            if (a.options.calendarEvents[i].date instanceof Array)
                for (
                    var o = a.getBetweenDates(a.options.calendarEvents[i].date), l = 0; l < o.length; l++
                )
                    e === o[l] && t === a.options.calendarEvents[i].type && n++;
            else
        ...
        if ((t.calculateDays(), !t.$elements.calendarEl.html())) {
            ...
            t.$elements.calendarEl.html(a),
                ...
                (e(t.$elements.sidebarEl).append(
                        '<span id="sidebarToggler" role="button" aria-pressed title="Close sidebar"><button class="icon-button"><span class="bars"></span></button></span>'
                    ),
                    t.$elements.sidebarToggler ||
                ...
                (e(t.$elements.calendarEl).append(
                        '<span id="eventListToggler" role="button" aria-pressed title="Close event list"><button class="icon-button"><span class="chevron-arrow-right"></span></button></span>'
                    ),
                    t.$elements.eventListToggler ||
    ...
    (t.prototype.addEventList = function(e) {
        ...
        0 === n.find("[data-event-index]").length && n.empty(),
            ...
            e.color ?
            (t += 'style="background-color:' + e.color + '"') :
            (t += 'class="event-bullet-' + e.type + '"'),
            (t +=
            ...
            (n.find('[data-event-index="' + e + '"]').remove(),
                ...
                (n.empty(),
                    (t =
                        ...
                        `<p>${a.initials.dates[a.options.language].noEventForToday}</p>` :
                        `<p>${
        ...
        if (i instanceof Array) {
            if (e.everyYear)
                for (var l = 0; l < i.length; l++)
                    i[l] = n.formatDate(
                        new Date(i[l]).setFullYear(n.$active.year),
                        n.options.format
                    );
    ...
    (t.prototype.selectEvent = function(t) {
        ...
        l.date instanceof Array && (l.dates_range = a.getBetweenDates(l.date)),
